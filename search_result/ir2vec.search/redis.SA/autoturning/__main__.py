...
if __name__ == '__main__':
    ...
    parser.add_argument(
                        ...
                        type=float,
                        default=0.5,
                        help=f"The percentage of gcc parameter bits when using mutation-based searchers, i.e., searchers in {MUTATION_BASED_SEARCHER}.")
    parser.add_argument("--crossover_bit_rate",
                        type=float,
                        default=None,
                        help=f"The percentage of crossover bits when using GA-based searchers, i.e., searchers in {GA_BASED_SEARCHER}")
    ...
    parser.add_argument('--rocksdb_build_home',
                        type=str,
                        default="/home/whq/dataset/rocksdb/rocksdb/build",
                        help='The path of rocksdb build directory.')
    parser.add_argument('--rocksdb_install_home',
                        type=str,
                        default="/home/whq/bin/rocksdb",
                        help='The path of rocksdb install directory.')
    parser.add_argument('--rocksdb_db_home',
                        type=str,
                        default="/home/whq/bin/db_rocksdb",
                        help='The path of rocksdb database directory.')
    # arguments for zstd
    # parser.add_argument('--zstd_build_home',
    #                     type=str,
    #                     default="/home/whq/workspace/zstd-instance5",
    #                     help='The path of zstd build directory.')
    parser.add_argument('--zstd_benchmark_core',
                        type=str,
                        default=310,
                        help='The core for zstd benchmark.')
    # arguments for mysql
    ...
    parser.add_argument('--mysql_install_home',
                        type=str,
                        help="The install home of mysql.")
    parser.add_argument('--mysql_data_home',
                        type=str,
                        help="The data home of mysql.")
    parser.add_argument('--mysql_test_home',
                        type=str,
                        help="The test home of mysql.")
    parser.add_argument('--mysql_cnf_file',
                        type=str,
                        help="The cnf file of mysql.")
    ...
    elif args.project is EvaluatorType.ROCKSDB:
        evaluator = RocksDBEvaluator(o3_project_path=args.o3_project_path,
                                     opt_project_path=args.opt_project_path,
                                     repeat_time=args.repeat,
                                     install_home=args.rocksdb_install_home,
                                     db_home=args.rocksdb_db_home)
    elif args.project is EvaluatorType.ZSTD:
        evaluator = ZstdEvaluator(o3_project_path=args.o3_project_path,
                                  opt_project_path=args.opt_project_path,
                                  repeat_time=args.repeat,
                                  benchmark_core=args.zstd_benchmark_core)
    elif args.project is EvaluatorType.MYSQL:
        evaluator = MysqlEvaluator(o3_project_path=args.o3_project_path,
                                   opt_project_path=args.opt_project_path,
                                   repeat_time=args.repeat,
                                   install_home=args.mysql_install_home,
                                   data_home=args.mysql_data_home,
                                   test_home=args.mysql_test_home,
                                   cnf_file=args.mysql_cnf_file)
    ...
    if args.searcher is SearcherType.RANDOM:
        searcher = RandomSearcher(ai4c_metadata=ai4c_metadata,
                                  ...
                                  gcc_param_bit_rate=args.gcc_param_bit_rate)
